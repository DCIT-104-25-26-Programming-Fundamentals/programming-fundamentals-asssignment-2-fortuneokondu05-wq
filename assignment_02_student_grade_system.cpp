...
#include <iostream>
using namespace std;
// Function that validates score and returns corresponding letter grade
char getGrade(int score) {
    // Validate: if score is out of range (less than 0 or greater than 100)
...
int main() {
    ...
    // Check if getGrade returned the null character error flag
    if (grade == '\0') {
